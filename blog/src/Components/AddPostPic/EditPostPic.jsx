...
import ImageCrop1 from './ImageCrop1';
...
class EditPostPic extends Component {
  ...
  onCrop = () => {
    ...
    if (editor !== null) {
      ...
      this.props.dispatch({ type: "postpic", payload: url })
  ...
  profilePicChange1 = (fileChangeEvent) => {
    console.log("hello")
    ...
    return (
      <div className="disabledrag" style={{ width: "max-content" }}>
        <input
          ...
          // multiple
          name="profilePicBtn1" accept="image/png, image/jpeg"
          type="file"
          onChange={this.profilePicChange1}
        />
